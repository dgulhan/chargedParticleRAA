...
// Thu Oct 22 22:25:42 2015 by ROOT version 6.02/10
// from TTree t/akPu4PFpatJets Jet Analysis Tree
// found on file: openHLT_HF.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         b;
   Int_t           nref;
   Float_t         rawpt[65];   //[nref]
   Float_t         jtpt[65];   //[nref]
   Float_t         jteta[65];   //[nref]
   Float_t         jty[65];   //[nref]
   Float_t         jtphi[65];   //[nref]
   Float_t         jtpu[65];   //[nref]
   Float_t         jtm[65];   //[nref]
   Float_t         discr_fr01[65];   //[nref]
   Float_t         trackMax[65];   //[nref]
   Float_t         trackSum[65];   //[nref]
   Int_t           trackN[65];   //[nref]
   Float_t         trackHardSum[65];   //[nref]
   Int_t           trackHardN[65];   //[nref]
   Float_t         chargedMax[65];   //[nref]
   Float_t         chargedSum[65];   //[nref]
   Int_t           chargedN[65];   //[nref]
   Float_t         chargedHardSum[65];   //[nref]
   Int_t           chargedHardN[65];   //[nref]
   Float_t         photonMax[65];   //[nref]
   Float_t         photonSum[65];   //[nref]
   Int_t           photonN[65];   //[nref]
   Float_t         photonHardSum[65];   //[nref]
   Int_t           photonHardN[65];   //[nref]
   Float_t         neutralMax[65];   //[nref]
   Float_t         neutralSum[65];   //[nref]
   Int_t           neutralN[65];   //[nref]
   Float_t         eMax[65];   //[nref]
   Float_t         eSum[65];   //[nref]
   Int_t           eN[65];   //[nref]
   Float_t         muMax[65];   //[nref]
   Float_t         muSum[65];   //[nref]
   Int_t           muN[65];   //[nref]
   Int_t           beamId1;
   Int_t           beamId2;
   Float_t         pthat;
   Float_t         refpt[65];   //[nref]
   Float_t         refeta[65];   //[nref]
   Float_t         refy[65];   //[nref]
   Float_t         refphi[65];   //[nref]
   Float_t         refdphijt[65];   //[nref]
   Float_t         refdrjt[65];   //[nref]
   Float_t         refparton_pt[65];   //[nref]
   Int_t           refparton_flavor[65];   //[nref]
   Int_t           refparton_flavorForB[65];   //[nref]
   Float_t         genChargedSum[65];   //[nref]
   Float_t         genHardSum[65];   //[nref]
   Float_t         signalChargedSum[65];   //[nref]
   Float_t         signalHardSum[65];   //[nref]
   Int_t           ngen;
   Int_t           genmatchindex[33];   //[ngen]
   Float_t         genpt[33];   //[ngen]
   Float_t         geneta[33];   //[ngen]
   Float_t         geny[33];   //[ngen]
   Float_t         genphi[33];   //[ngen]
   Float_t         gendphijt[33];   //[ngen]
   Float_t         gendrjt[33];   //[ngen]
