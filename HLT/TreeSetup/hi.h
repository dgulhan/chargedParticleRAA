...
// Sat Oct 10 17:37:59 2015 by ROOT version 6.02/10
// from TTree hi/Tree of Hi gen Event
// found on file: HLT_HydjetMB_740pre8_MCHI2_74_V3_53XBS.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   hi(TString infile,TTree *tree=0);
   virtual ~hi();
...
#ifdef hi_cxx
hi::hi(TString infile,TTree *tree) : fChain(0) 
{
   f = TFile::Open(infile);
